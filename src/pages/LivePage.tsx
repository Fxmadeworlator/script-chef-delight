...
export const LivePage = ({ onPageChange }: LivePageProps = {}) => {
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      {/* Previous Live Sessions - YouTube grid */}
      <section className="py-16 container mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground mt-2">
            Watch past services, prayers and special events on demand.
          </p>
        </div>
            ...
            >
              ...
              <div className="aspect-video bg-black relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <PlayCircle className="h-12 w-12 text-white/80 group-hover:text-white group-hover:scale-110 transition-transform" />
                </div>
              </div>
